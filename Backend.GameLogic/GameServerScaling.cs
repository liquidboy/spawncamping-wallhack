namespace Backend.GameLogic
{
    ...
    public class GameServerScaling : IPartImportsSatisfiedNotification
    {
        ...
        {
            var servicename = this.LobbyServiceSettings.GameServerCloudServiceName;
        ...
        {
            var managementCertThumbprint = this.LobbyServiceSettings.SubscriptionManagementCertificateThumbprint;
        ...
        {
            string subscriptionId = this.LobbyServiceSettings.SubscriptionID;
